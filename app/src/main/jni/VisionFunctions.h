 ...
 */
std::vector<cv::RotatedRect> getSampleSquares(const cv::Mat srcImage, const cv::RotatedRect& target, const cv::RotatedRect& ref, const int& OP_CODE, bool debug = false);
